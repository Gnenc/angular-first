(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! /home/gonenc/Desktop/test_app/firstAngular/src/main.ts */
      "zUnb");
      /***/
    },
    ...
    function Hsdx(module, __webpack_exports__, __webpack_require__) {
      ...
      function ProductListComponent_div_2_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProductListComponent_div_2_Template_button_click_5_listener() {
            ...
            return ctx_r5.share(product_r1.name);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("notify", function ProductListComponent_div_2_Template_app_product_alerts_notify_7_listener() {
            ...
            return ctx_r7.onNotify(product_r1.name);
          });
      ...
      var ProductListComponent = /*#__PURE__*/function () {
        ...
        _createClass(ProductListComponent, [{
          key: "share",
          value: function share(product) {
            window.alert("The ".concat(product, " has been shared!"));
          }
        }, {
          key: "onNotify",
          value: function onNotify(product) {
            window.alert("You will be notified when the ".concat(product, " goes on sale"));
          }
        }]);
    ...
    function c2A7(module, __webpack_exports__, __webpack_require__) {
      ...
      CartComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 17,
        vars: 4,
        consts: [[3, "routerLink"], ["class", "cart-item", 4, "ngFor", "ngForOf"], [3, "formGroup", "ngSubmit"], ["for", "name"], ["id", "name", "type", "text", "formControlName", "name"], ["for", "address"], ["id", "address", "type", "text", "formControlName", "address"], ["type", "submit", 1, "button"], [1, "cart-item"]],
